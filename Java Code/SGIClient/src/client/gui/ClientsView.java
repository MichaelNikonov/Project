...
public class ClientsView extends JPanel
{
	...
	public void initialize()
	{
		...
		table = new JTable(createDataModel());
		...
		JLabel title = new JLabel("Client ID: ");
	...
	{
		dataValues = new String[_clients.size()][_numOfRows];
	...
	private DefaultTableModel createDataModel()
	{
		...
		dm = new DefaultTableModel(dataValues, columnNames);
		return dm;
	}
